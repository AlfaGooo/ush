...
void mx_del_node(t_tnode **root, void *data, int (*cmp)(void *, void *), void (*free_tnode)(t_tnode *tnode));
void mx_out_ni(char **mas_name, int pid);
void mx_del_param(t_info *info);
void mx_del_leaks(t_info *info);
void mx_del_if_noch(t_tnode **root, void *data, int (*cmp)(void *, void *), void (*free_tnode)(t_tnode *tnode));
void mx_del_leaks_pid(t_info *info, int pid);
void mx_delete_tnodeb(t_tnode **root, void *data, int (*cmp)(void *, void *), void (*free_tnode)(t_tnode *tnode));
void mx_delete_tnodea(t_tnode **root, int (*cmp)(void *, void *), t_tnode *finded, void (*free_tnode)(t_tnode *tnode));
void mx_del_tokens(t_list **tokens);
void mx_del_tree(t_tnode **root);
